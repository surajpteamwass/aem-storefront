...
const formatRequest = (env, request, url) => {
  ...
  // Preview / branch hosts use aem.page; production Live often uses aem.live (set in wrangler vars).
  const edgeDomain = env.AEM_EDGE_DOMAIN || 'aem.live';
  aemUrl.hostname = `main--${env.AEM_SITE}--${env.AEM_ORG}.${edgeDomain}`;
  aemUrl.port = '';
